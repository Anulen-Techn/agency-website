      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <AnimatedContainer delay={0.15} className="relative">
          <div className="grid grid-cols-[1.1fr_0.95fr] gap-6">
            ...
            <div className="rounded-[1.5rem] bg-white/75 p-8 shadow-sm">
              <h2 className="text-7xl font-black leading-none tracking-[-0.07em]">30+</h2>
              <p className="mt-5 text-sm leading-6 text-neutral-500">websites, tools, and systems designed to help brands grow.</p>
              <div className="mt-9 h-1.5 rounded-full bg-neutral-200">
