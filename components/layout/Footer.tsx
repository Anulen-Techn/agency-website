    ...
    <footer className="px-6 py-16 md:px-12 lg:px-20">
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.5fr_0.7fr_0.7fr_0.9fr]">
        <div>
          ...
          <div className="mt-8 flex gap-4">
            {[FaFacebookF, FaXTwitter, FaLinkedinIn, FaInstagram].map((Icon, index) => (
              <span key={index} className="flex h-9 w-9 items-center justify-center rounded-full bg-white">
                <Icon size={14} />
              </span>
            ))}
          </div>
        ...
        <div>
          ...
          <div className="mt-8 flex flex-col gap-5 text-sm text-neutral-500">
            <a href="#">Service</a>
            <a href="#">Agency</a>
            <a href="#">Case Study</a>
            <a href="#">Resource</a>
